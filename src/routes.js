...
import Address from "containers/ContentPage/components/Setting/components/Address/Address";
...
export const Routes = {
  ...
  CheckoutStatusPage: (props) =>
    configPublicRoute("checkout/*", false, <CheckoutStatus {...props} />),
  CheckoutPage: (props) =>
    configPublicRoute("checkout", false, <Checkout {...props} />),
  InvoicePage: (props) =>
